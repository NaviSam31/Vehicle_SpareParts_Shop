...
/**
 * Servlet implementation class DisplaySupplierRequestsServlet
 */
public class DisplaySupplierRequestsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (page != null && !page.isEmpty()) {
            if (page.equals("supplier")) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("SupplierRequests.jsp");
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("ViewRejectedOrders.jsp");
                dispatcher.forward(request, response);
            }
        } else {
